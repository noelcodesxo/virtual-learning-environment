...
A compact topic map accompanies the excerpts. Use it to balance coverage across the entire selected chapter or document. Cover its most important ideas from beginning to end when the requested question count allows, including material near the middle and end. Treat the supplied excerpts as the only evidence. The learner selects Bloom's taxonomy levels: tailor each question to a selected level and use reference questions only to match cognitive demand, never to copy their content. For create questions, assess the best supported plan or construction in multiple-choice form.
